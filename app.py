from flask import Flask, flash, request, redirect, send_file, url_for, render_template,jsonify
from blur import convert_to_colour, convert_to_grayscale, blur_image #importing all the functions from blur.py
import os
import json
